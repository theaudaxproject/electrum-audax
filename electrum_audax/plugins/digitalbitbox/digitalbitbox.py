...
from electrum_audax.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_audax.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                                   is_address)
from electrum_audax.bip32 import BIP32Node
from electrum_audax import ecc
from electrum_audax.ecc import msg_magic
from electrum_audax.wallet import Standard_Wallet
from electrum_audax import constants
from electrum_audax.transaction import Transaction
from electrum_audax.i18n import _
from electrum_audax.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from electrum_audax.util import to_string, UserCancelled, UserFacingException
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-AUDAX-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
