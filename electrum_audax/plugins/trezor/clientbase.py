...
from electrum_audax.util import UserCancelled, UserFacingException
from electrum_audax.keystore import bip39_normalize_passphrase
...
from electrum_audax.plugins.hw_wallet.plugin import OutdatedHwFirmwareException
    ...
    def get_passphrase(self):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the AUDAX in the wallet.").format(self.device)
        else:
