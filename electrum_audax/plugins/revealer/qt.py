...
from electrum_audax.util import make_dir, InvalidPassword, UserCancelled
from electrum_audax.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                  WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_audax.plugin import hook
from electrum_audax.i18n import _

from electrum_audax.gui.qt.qrtextedit import ScanQRTextEdit
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_audax.gui.qt.password_dialog import PasswordDialog
