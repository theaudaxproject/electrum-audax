...
from electrum_audax.bitcoin import TYPE_ADDRESS, int_to_hex, var_int, is_segwit_script_type
...
from electrum_audax.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_audax.base_wizard import ScriptTypeNotSupported
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Audax" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
