...
from electrum_audax.daemon import Daemon
from electrum_audax.storage import WalletStorage
from electrum_audax.wallet import Wallet, create_new_wallet
from electrum_audax.commands import Commands


config = SimpleConfig({"testnet": True})  # to use ~/.electrum-audax/testnet as datadir
