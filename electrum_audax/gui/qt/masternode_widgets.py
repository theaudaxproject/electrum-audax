...
from electrum_audax.bitcoin import COIN
from electrum_audax.i18n import _
from electrum_audax.masternode import NetworkAddress, MasternodeAnnounce
...
class PrevOutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hash_edit.setPlaceholderText(_('The TxID of your 2500 AUDAX output'))
        self.index_edit = QLineEdit()
        self.index_edit.setPlaceholderText(_('The output number of your 2500 AUDAX output'))
        self.address_edit = QLineEdit()
        self.address_edit.setPlaceholderText(_('The address that 2500 AUDAX was sent to'))
...
class MasternodeEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        form.addRow(_('Collateral AUDAX Output:'), self.vin_edit)
...
class SignAnnounceWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        form = QFormLayout()
        form.addRow(_('Alias:'), self.alias_edit)
        form.addRow(_('Collateral AUDAX Output:'), self.collateral_edit)
