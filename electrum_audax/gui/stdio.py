...
from electrum_audax.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def network_dialog(self):
        print("use 'electrum-audax setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-audax setconfig' to change your settings")
        return True
