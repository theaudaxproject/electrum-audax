...
from electrum_audax.util import InvalidPassword
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            IconButton:
                size_hint: 0.5, None
                height: '48dp'
                icon: 'atlas://electrum_audax/gui/kivy/theming/light/qrcode'
...
class TxDialog(Factory.Popup):
    ...
    def show_qr(self):
        from electrum_audax.bitcoin import base_encode, bfh
        raw_tx = str(self.tx)
        text = bfh(raw_tx)
