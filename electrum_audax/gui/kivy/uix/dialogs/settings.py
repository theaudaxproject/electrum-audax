...
from electrum_audax.util import base_units_list
...
from electrum_audax import coinchooser
...
<SettingsDialog@Popup>
    id: settings
    title: _('Electrum-AUDAX Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Audax amounts.")
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file(
                'electrum_audax/gui/kivy/uix/ui_screens/proxy.kv')
