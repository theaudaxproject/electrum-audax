...
from electrum_audax.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_audax import bitcoin
from electrum_audax.transaction import TxOutput
from electrum_audax.util import send_exception_to_crash_reporter
...
from electrum_audax.gui.kivy.i18n import _
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file(
            'electrum_audax/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_hash, tx_mined_status, value, balance):
        ...
        icon = "atlas://electrum_audax/gui/kivy/theming/light/" + \
            TX_ICONS[status]
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        ...
        try:
            ...
            self.app.show_info(_("Not a Audax URI"))
            return
    ...
    def do_save(self):
        ...
        from electrum_audax.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_audax.util import create_bip21_uri
    ...
    def do_share(self):
        uri = self.get_URI()
        self.app.do_share(uri, _("Share Audax Request"))
