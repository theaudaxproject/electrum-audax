...
This guide explains how to build Electrum-MUE binaries for macOS systems.
...
#### 1.2 Build Electrum-MUE

    cd electrum-mue
    ./contrib/osx/make_osx

This creates both a folder named Electrum-MUE.app and the .dmg file.
...
Copy the Electrum-MUE.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd electrum-mue
    ./contrib/osx/package.sh ~/Electrum-MUE.app/
