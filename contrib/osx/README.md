...
This guide explains how to build Electrum-AUDAX binaries for macOS systems.
...
#### 1.2 Build Electrum-AUDAX

    cd electrum-audax
    ./contrib/osx/make_osx

This creates both a folder named Electrum-AUDAX.app and the .dmg file.
...
Copy the Electrum-AUDAX.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd electrum-audax
    ./contrib/osx/package.sh ~/Electrum-AUDAX.app/
