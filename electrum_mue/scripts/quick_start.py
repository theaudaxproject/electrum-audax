...
from electrum_mue.daemon import Daemon
from electrum_mue.storage import WalletStorage
from electrum_mue.wallet import Wallet, create_new_wallet
from electrum_mue.commands import Commands


config = SimpleConfig({"testnet": True})  # to use ~/.electrum-mue/testnet as datadir
