...
from electrum_mue.util import print_msg, create_and_start_event_loop
from electrum_mue.synchronizer import SynchronizerBase


try:
    addr = sys.argv[1]
except Exception:
    print("usage: watch_address <monetaryunit_address>")
    sys.exit(1)
