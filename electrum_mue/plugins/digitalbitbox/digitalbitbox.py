...
from electrum_mue.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_mue.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                                   is_address)
from electrum_mue.bip32 import BIP32Node
from electrum_mue import ecc
from electrum_mue.ecc import msg_magic
from electrum_mue.wallet import Standard_Wallet
from electrum_mue import constants
from electrum_mue.transaction import Transaction
from electrum_mue.i18n import _
from electrum_mue.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from electrum_mue.util import to_string, UserCancelled, UserFacingException
from electrum_mue.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_mue.network import Network
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-MUE-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
...
class DigitalBitboxPlugin(HW_PluginBase):
    ...
    def setup_device(self, device_info, wizard, purpose):
        ...
        client.get_xpub("m/44'/222'", 'standard')
