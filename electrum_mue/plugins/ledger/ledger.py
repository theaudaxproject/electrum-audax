...
from electrum_mue.bitcoin import TYPE_ADDRESS, int_to_hex, var_int, is_segwit_script_type
...
from electrum_mue.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_mue.base_wizard import ScriptTypeNotSupported
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "MonetaryUnit" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
