...
from electrum_mue.util import make_dir, InvalidPassword, UserCancelled
from electrum_mue.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                  WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_mue.plugin import hook
from electrum_mue.i18n import _

from electrum_mue.gui.qt.qrtextedit import ScanQRTextEdit
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_mue.gui.qt.password_dialog import PasswordDialog
