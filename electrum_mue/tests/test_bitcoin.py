...
from electrum_mue.bitcoin import (public_key_to_p2pkh, address_from_private_key,
...
from electrum_mue.bip32 import (BIP32Node, convert_bip32_intpath_to_strpath,
                                 xpub_from_xprv, xpub_type, is_xprv, is_bip32_derivation,
                                 is_xpub, convert_bip32_path_to_list_of_uint32,
                                 normalize_bip32_derivation)
from electrum_mue.crypto import sha256d, SUPPORTED_PW_HASH_VERSIONS
from electrum_mue import ecc, crypto, constants
from electrum_mue.ecc import number_to_string, string_to_number
from electrum_mue.util import bfh, bh2u, InvalidPassword
from electrum_mue.storage import WalletStorage
from electrum_mue.keystore import xtype_from_derivation

from electrum_mue import ecc_fast
...
class Test_bitcoin(SequentialTestCase):
    ...
    def test_address_to_script(self):
        ...
        # TODO: MUE doesn't support segwit yet (check BIP141 / 143)
