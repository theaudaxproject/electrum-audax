...
from electrum_mue.util import format_satoshis, format_fee_satoshis, parse_URI
...
class TestUtil(SequentialTestCase):
    ...
    def test_parse_URI_address(self):
        self._do_test_parse_URI('monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt',
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt?label=electrum%20test',
                                {'address': 'GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt', 'label': 'electrum test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt?message=electrum%20test',
                                {'address': 'GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt', 'message': 'electrum test', 'memo': 'electrum test'})

    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt?amount=0.0003',
                                {'address': 'GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt', 'amount': 30000})

    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI('monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'address': 'GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt', 'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_ignore_args(self):
        self._do_test_parse_URI('monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt?test=test',
                                {'address': 'GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt', 'test': 'test'})

    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
    ...
    def test_parse_URI_invalid(self):
        self.assertRaises(BaseException, parse_URI,
                          'notmonetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt')

    def test_parse_URI_parameter_polution(self):
        self.assertRaises(
            Exception, parse_URI, 'monetaryunit:GLosAyGUGzvqT4fxpzFCosY8f6ZZdQyXJt?amount=0.0003&label=test&amount=30.0')
