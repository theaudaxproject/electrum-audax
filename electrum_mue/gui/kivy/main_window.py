...
from electrum_mue.paymentrequest import InvoiceStore
from electrum_mue.util import profiler, InvalidPassword, send_exception_to_crash_reporter
from electrum_mue.plugin import run_hook
from electrum_mue.util import format_satoshis, format_satoshis_plain
from electrum_mue.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrum_mue import blockchain
...
#Factory.register('InstallWizard', module='electrum_mue.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_mue.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_mue.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_mue.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_mue_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_mue.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrum_mue/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_mue/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_mue/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_mue/gui/kivy/data/fonts/Roboto-Bold.ttf')


from electrum_mue.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrum_mue.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_mue.transaction import Transaction
        from electrum_mue.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_mue.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('electrum_mue/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def build(self):
        return Builder.load_file('electrum_mue/gui/kivy/main.kv')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_mue/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_mue.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_mue.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_mue_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_mue_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-mue.png"
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_mue/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_mue/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_mue/gui/kivy/theming/light/card'
        else:
