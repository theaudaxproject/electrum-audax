...
from electrum_mue.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_mue import bitcoin
from electrum_mue.transaction import TxOutput
from electrum_mue.util import send_exception_to_crash_reporter
from electrum_mue.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrum_mue.plugin import run_hook
from electrum_mue.wallet import InternalAddressCorruption

from .context_menu import ContextMenu


from electrum_mue.gui.kivy.i18n import _
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file(
            'electrum_mue/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_hash, tx_mined_status, value, balance):
        ...
        icon = "atlas://electrum_mue/gui/kivy/theming/light/" + \
            TX_ICONS[status]
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from electrum_mue.paymentrequest import make_unsigned_request, PaymentRequest
        ...
        if self.screen.is_pr:
            ...
            if not address:
                self.app.show_error(_('Recipient not specified.') + ' ' +
                                    _('Please scan a MonetaryUnit address or a payment request'))
                return
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_mue.util import create_bip21_uri
